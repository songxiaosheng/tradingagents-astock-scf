/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 83d1158fe7f50286c2f4aa6ab7328f19)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	JOBS: KVNamespace;
	ASSETS: Fetcher;
	ADMIN_USERNAME: "admin";
	TENCENT_FUNCTION: "tradingagents-astock-job";
	TENCENT_NAMESPACE: "default";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_USERNAME" | "TENCENT_FUNCTION" | "TENCENT_NAMESPACE" | "TENCENT_REGION" | "ADMIN_PASSWORD" | "CALLBACK_SECRET" | "TENCENT_SECRET_ID" | "TENCENT_SECRET_KEY">> {}
}
